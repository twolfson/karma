...
var processShared = function (argv, options, fs, path) {
  optimist
...
var processInit = function (argv, options, fs, path) {
  optimist
    .usage('Karma - Spectacular Test Runner for JavaScript.\n\n' +
...
var processStart = function (argv, options, fs, path) {
  optimist
    .usage('Karma - Spectacular Test Runner for JavaScript.\n\n' +
...
var processRun = function (argv, options, fs, path) {
  optimist
    .usage('Karma - Spectacular Test Runner for JavaScript.\n\n' +
...
var processStop = function (argv, options, fs, path) {
  optimist
    .usage('Karma - Spectacular Test Runner for JavaScript.\n\n' +
...
var processCompletion = function (argv, options, fs, path) {
  optimist
    .usage('Karma - Spectacular Test Runner for JavaScript.\n\n' +
...
exports.process = function () {
  ...
  switch (options.cmd) {
    case 'start':
      return processStart(argv, options, fs, path)

    case 'run':
      return processRun(argv, options, fs, path)

    case 'stop':
      return processStop(argv, options, fs, path)

    case 'init':
      return processInit(argv, options, fs, path)

    case 'completion':
      return processCompletion(argv, options, fs, path)

    default:
      return processShared(argv, options, fs, path)
  }
}
